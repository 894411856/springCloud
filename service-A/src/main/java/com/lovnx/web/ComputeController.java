...
public class ComputeController {
    ...
    //A服务调用B2服务
    @RequestMapping(value="testServiceB2",method=RequestMethod.GET)
    public String testServiceB2(@RequestParam Integer a,@RequestParam Integer b){
        logger.info("A服务调用B:service-B");
        RestTemplate restTemplate = new RestTemplate();
